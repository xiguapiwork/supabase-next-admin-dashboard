          ...
          <HoverCard>
            <HoverCardTrigger asChild>
              <Link
                ...
                target="_blank"
                className="flex items-center px-4 w-full rounded-none text-sm py-2 h-auto justify-start gap-3 text-left hover:bg-accent"
              >
    ...
    return (
      <QueryClientProvider client={queryClient}>
        <Dialog open={open} onOpenChange={onOpenChange}>
          <DialogContent className="w-full h-[80vh] max-h-[700px] sm:max-w-[calc(100%-2rem)] max-w-[1180px] p-0 overflow-hidden sm:rounded-lg">
